...
const userSchema = mongoose.Schema({
    ...
    password: {type: String, required: true}, // pwd
    type: {type: String, required: true}, // user type applicant/employer 
    header: {type: String}, // avatar name
    post: {type: String}, // position
    info: {type: String}, // position description
...
const chatSchema = mongoose.Schema({
    ...
    to: {type: String, required: true}, // receive user's id
    chat_id: {type: String, required: true}, // from and to's string
    content: {type: String, required: true}, // content
    read: {type: Boolean, default: false}, // isread
